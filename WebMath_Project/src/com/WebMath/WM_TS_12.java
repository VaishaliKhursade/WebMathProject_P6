...
public void ToMainFrame() {
	...
	public void TC1() throws Exception {
		...
		driver.findElement(By.xpath("//a[text()='Multiply']")).click();
		Thread.sleep(1000);
		String actTitle = driver.getTitle();

		String expextedTitle = "Multiply Two Fractions - WebMath";

		Assert.assertEquals(actTitle, expextedTitle,
				"Test Failed User not nevigated to Multiply Two Fractions page successfully");
	...
	public void TC2() throws Exception {
		...
		WebElement Mulbtn = driver.findElement(By.xpath("//input[@value='Multiply']"));
		...
		Assert.assertTrue(Mulbtn.isDisplayed(), " Multiply Button is not visible");
		...
		Assert.assertTrue(Mulbtn.isEnabled(), " Multiply Button is disabled");
	...
	public void TC4() throws Exception {
		...
		String ExpResult = "The problem here is to multiply and\r\n"
				+ "This problem can be solved by multiplying together the two numerators (the 5 and 7),\r\n"
				+ "giving 35, which will be the numerator in our answer.\r\n"
				+ "\r\n"
				+ "Also, we'll multiply together the two denominators (the 2 and 4),\r\n"
				+ "giving 8, which will be the denominator in our answer.\r\n"
				+ "\r\n"
				...
				+ "\r\n"
				+ "The whole number part of the mixed number is found by dividing the 35 by the 8.\r\n"
				+ "In this case we get 4.\r\n"
				+ "\r\n"
				+ "The fractional part of the mixed number is found by using the remainder of the division,\r\n"
				+ "which in this case is 3 (35 divided by 8 is 4 remainder 3).\r\n"
				+ "\r\n"
				+ "The final answer is: ";
	...
	@Test(priority = 5, description = "Validating Result Accuricy 3")
	...
	public void TC5() throws Exception {
		...
		Thread.sleep(1000);
	driver.findElement(By.xpath("//input[@name='btop1']")).sendKeys("4");
	driver.findElement(By.xpath("//input[@name='bbottom1']")).sendKeys("2");
	driver.findElement(By.xpath("//input[@name='btop2']")).sendKeys("8");
	driver.findElement(By.xpath("//input[@name='bbottom2']")).sendKeys("4");
	driver.findElement(By.xpath("//input[@name='bwhole1']")).sendKeys("2");
	...
	driver.switchTo().frame(ResultFrame);
	String Result = driver.findElement(By.xpath("/html/body/font/font/p[15]/font/font/font/table/tbody/tr/td/font/font/center")).getText();

	String ExpResult = "The final answer is: 8 ";
	Assert.assertNotEquals(Result, ExpResult, "Test fail calculetion is not correct");

}
	
	@Test(priority = 6, description = "Validating Result Accuricy 2")
	...
	String ExpResult = "The problem here is to multiply and\r\n"
			...
			+ "\r\n"
			+ "This problem can be solved by multiplying together the two numerators (the 9 and 14),\r\n"
			+ "giving 126, which will be the numerator in our answer.\r\n"
			+ "\r\n"
			+ "Also, we'll multiply together the two denominators (the 3 and 5),\r\n"
			+ "giving 15, which will be the denominator in our answer.\r\n"
			+ "\r\n"
			+ "Doing so, we get an answer of\r\n"
			+ "\r\n"
			+ "\r\n"
			...
			+ "simplified further into a mixed number.\r\n"
			+ "\r\n"
			+ "The whole number part of the mixed number is found by dividing the 126 by the 15.\r\n"
			+ "In this case we get 8.\r\n"
			+ "\r\n"
			+ "The fractional part of the mixed number is found by using the remainder of the division,\r\n"
			+ "which in this case is 6 (126 divided by 15 is 8 remainder 6).\r\n"
			+ "\r\n"
			...
			+ "or Greatest Common Factor (GCF) of the numbers 6 and 15.\r\n"
	...
	public void TC7() throws Exception {
	  ...
	  expextedTitle = "Multiply Two Fractions - WebMath";
	  Assert.assertEquals(actTitle, expextedTitle,
	  "Test Failed User not nevigated Multiply Two Fractions page successfully"
	  );
