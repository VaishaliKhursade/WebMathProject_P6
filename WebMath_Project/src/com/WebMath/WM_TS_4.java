...
public class WM_TS_4 {
	...
	public void TC1() throws Exception {
		...
		driver.findElement(By.xpath("//a[text()='GCF']")).click();
		Thread.sleep(1000);
		String actTitle = driver.getTitle();

		String expextedTitle = "Find the Greatest Common Factor - WebMath";

		Assert.assertEquals(actTitle, expextedTitle,
				"Test Failed User not nevigated to Find the Greatest Common Factor page successfully");
	...
	public void TC2() throws Exception {
		...
		Assert.assertTrue(btn.isDisplayed(), " GCF btn is not visible");
	...
	public void TC4() throws Exception {
		...
		String ExpResult = "The Greatest Common Factor (GCF) of the numbers\r\n"
				+ "12,15\r\n"
				+ "is\r\n"
				+ "3\r\n"
				+ "because 3 is the greatest number that divides evenly into all of them.";
